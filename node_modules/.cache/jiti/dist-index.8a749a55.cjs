"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.clearResolveCache = clearResolveCache;exports.createResolver = createResolver;exports.resolveModulePath = resolveModulePath;exports.resolveModuleURL = resolveModuleURL;var _nodeFs = _interopRequireWildcard(require("node:fs"));
...
var _nodeUtil = require("node:util");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}function _getRequireWildcardCache(e) {if ("function" != typeof WeakMap) return null;var r = new WeakMap(),t = new WeakMap();return (_getRequireWildcardCache = function (e) {return e ? t : r;})(e);}function _interopRequireWildcard(e, r) {if (!r && e && e.__esModule) return e;if (null === e || "object" != typeof e && "function" != typeof e) return { default: e };var t = _getRequireWildcardCache(r);if (t && t.has(e)) return t.get(e);var n = { __proto__: null },a = Object.defineProperty && Object.getOwnPropertyDescriptor;for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) {var i = a ? Object.getOwnPropertyDescriptor(e, u) : null;i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u];}return n.default = e, t && t.set(e, n), n;}
...
function isErrorStackTraceLimitWritable() {
  try {
    if (_nodeV.default.startupSnapshot.isBuildingSnapshot()) {
      return false;
    }
  } catch {
  }
...
function getMessage(key, parameters, self) {
  ...
  (0, _nodeAssert.default)(message !== void 0, "expected `message` to be found");
  if (typeof message === "function") {
    (0, _nodeAssert.default)(
...
function determineSpecificType(value) {
  ...
  if (typeof value === "object") {
    ...
    return `${(0, _nodeUtil.inspect)(value, { depth: -1 })}`;
  }
  let inspected = (0, _nodeUtil.inspect)(value, { colors: false });
  ...
  if (string !== void 0) {
    ...
    try {
      ...
      const error = new ERR_INVALID_PACKAGE_CONFIG(
        jsonPath,
        (base ? `"${specifier}" from ` : "") + (0, _nodeUrl.fileURLToPath)(base || specifier),
        error_.message
      );
      error.cause = error_;
      throw error;
...
function emitInvalidSegmentDeprecation(target, request, match, packageJsonUrl, internal, base, isTarget) {
  ...
  _nodeProcess.default.emitWarning(
    `Use of deprecated ${double ? "double slash" : "leading or trailing slash matching"} resolving "${target}" for module request "${request}" ${request === match ? "" : `matched to "${match}" `}in the "${internal ? "imports" : "exports"}" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${(0, _nodeUrl.fileURLToPath)(base)}` : ""}.`,
    "DeprecationWarning",
    "DEP0166"
  );
}
function emitLegacyIndexDeprecation(url, packageJsonUrl, base, main) {
  ...
  const packagePath = (0, _nodeUrl.fileURLToPath)(new _nodeUrl.URL(".", packageJsonUrl));
...
function tryStatSync(path2) {
  try {
    return (0, _nodeFs.statSync)(path2);
  } catch {
  }
}
function fileExists(url) {
  const stats = (0, _nodeFs.statSync)(url, { throwIfNoEntry: false });
...
function legacyMainResolve(packageJsonUrl, packageConfig, base) {
  ...
  if (packageConfig.main !== void 0) {
    ...
    while (++i2 < tries2.length) {
      guess = new _nodeUrl.URL(tries2[i2], packageJsonUrl);
  ...
  throw new ERR_MODULE_NOT_FOUND(
    (0, _nodeUrl.fileURLToPath)(new _nodeUrl.URL(".", packageJsonUrl)),
    (0, _nodeUrl.fileURLToPath)(base)
  );
}
function finalizeResolution(resolved, base, preserveSymlinks) {
  ...
  if (!stats || !stats.isFile()) {
    const error = new ERR_MODULE_NOT_FOUND(
      ...
      base && (0, _nodeUrl.fileURLToPath)(base),
      true
    );
    error.url = String(resolved);
    throw error;
...
function importNotDefined(specifier, packageJsonUrl, base) {
  return new ERR_PACKAGE_IMPORT_NOT_DEFINED(
    specifier,
    packageJsonUrl && (0, _nodeUrl.fileURLToPath)(new _nodeUrl.URL(".", packageJsonUrl)),
    (0, _nodeUrl.fileURLToPath)(base)
  );
}
...
function resolvePackageTargetString(target, subpath, match, packageJsonUrl, base, pattern, internal, isPathMap, conditions) {
  ...
  const resolved = new _nodeUrl.URL(target, packageJsonUrl);
  const resolvedPath = resolved.pathname;
  const packagePath = new _nodeUrl.URL(".", packageJsonUrl).pathname;
    ...
    while (++i < keys.length) {
      ...
      if (isArrayIndex(key)) {
        throw new ERR_INVALID_PACKAGE_CONFIG(
          (0, _nodeUrl.fileURLToPath)(packageJsonUrl),
          (0, _nodeUrl.fileURLToPath)(base),
...
function emitTrailingSlashPatternDeprecation(match, pjsonUrl, base) {
  ...
  _nodeProcess.default.emitWarning(
    `Use of deprecated trailing slash pattern mapping "${match}" in the "exports" field module resolution of the package at ${pjsonPath}${base ? ` imported from ${(0, _nodeUrl.fileURLToPath)(base)}` : ""}. Mapping specifiers ending in "/" is no longer supported.`,
    "DeprecationWarning",
    "DEP0155"
  );
}
...
function packageResolve(specifier, base, conditions) {
  ...
  if (packageConfig.exists && packageConfig.name === packageName && packageConfig.exports !== void 0 && packageConfig.exports !== null) {
    const packageJsonUrl2 = (0, _nodeUrl.pathToFileURL)(packageConfig.pjsonPath);
  ...
  let packageJsonUrl = new _nodeUrl.URL(
  ...
  do {
    ...
    if (!stat || !stat.isDirectory()) {
      ...
      packageJsonUrl = new _nodeUrl.URL(
    ...
    return new _nodeUrl.URL(packageSubpath, packageJsonUrl);
...
function moduleResolve(specifier, base, conditions, preserveSymlinks) {
  ...
  (0, _nodeAssert.default)(resolved !== void 0, "expected to be defined");
...
function resolveModuleURL(input, options) {
  ...
  if (absolutePath) {
    try {
      if ((0, _nodeFs.statSync)(absolutePath).isFile()) {
        if (cacheObj) {
...
function resolveModulePath(id, options) {
  ...
  const absolutePath = (0, _nodeUrl.fileURLToPath)(resolved);
...
function _normalizeBases(inputs) {
  ...
  if (urls.length === 0) {
    return [(0, _nodeUrl.pathToFileURL)("./")];
  }
  return urls;
}
function _normalizeBase(input) {
  ...
  try {
    if (input.endsWith("/") || (0, _nodeFs.statSync)(input).isDirectory()) {
      return (0, _nodeUrl.pathToFileURL)(input + "/");
    }
    return (0, _nodeUrl.pathToFileURL)(input);
  } catch {
    return [(0, _nodeUrl.pathToFileURL)(input + "/"), (0, _nodeUrl.pathToFileURL)(input)];
  }
}
function _fmtPath(input) {
  try {
    return (0, _nodeUrl.fileURLToPath)(input);
  } catch {
    return input;
  }
}
...
function _parseInput(input) {
  if (typeof input === "string") {
    if (input.startsWith("file:")) {
      ...
      return { url, absolutePath: (0, _nodeUrl.fileURLToPath)(url) };
    }
    if ((0, _nodePath.isAbsolute)(input)) {
      return { url: (0, _nodeUrl.pathToFileURL)(input), absolutePath: input };
    }
  ...
  if (input instanceof URL) {
    if (input.protocol === "file:") {
      return { url: input, absolutePath: (0, _nodeUrl.fileURLToPath)(input) };
    }
