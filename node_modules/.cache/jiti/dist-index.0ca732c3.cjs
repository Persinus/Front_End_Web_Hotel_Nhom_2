"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.captureRawStackTrace = captureRawStackTrace;exports.captureStackTrace = captureStackTrace;exports.parseRawStackTrace = parseRawStackTrace;const IS_ABSOLUTE_RE = /^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[a-z]:[/\\]/i;
...
function parseRawStackTrace(stacktrace) {
  ...
  for (const line of stacktrace.split("\n")) {
    ...
    if (parsed.source === "file:///C:/Users/admin/Documents/Front_End_Web_Hotel_Nhom_2/node_modules/errx/dist/index.js") {
      continue;
    }
