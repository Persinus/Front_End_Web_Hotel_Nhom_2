"use strict";Object.defineProperty(exports, "__esModule", { value: true });Object.defineProperty(exports, "applyDefaults", { enumerable: true, get: function () {return _untypedBTwOq8Jl.a;} });Object.defineProperty(exports, "defineUntypedSchema", { enumerable: true, get: function () {return _untypedBr_uXjZG.d;} });exports.generateMarkdown = generateMarkdown;exports.generateTypes = generateTypes;Object.defineProperty(exports, "resolveSchema", { enumerable: true, get: function () {return _untypedBTwOq8Jl.r;} });var _untypedBTwOq8Jl = require("./shared/untyped.BTwOq8Jl.mjs");
var _knitwork = require("knitwork");
var _untypedBr_uXjZG = require("./shared/untyped.Br_uXjZG.mjs");
...
function _genTypes(schema, spaces, opts) {
  ...
  for (const key in schema.properties) {
    ...
    if (val.tsType) {
      buff.push(
        `${(0, _knitwork.genObjectKey)(key)}${isRequired(schema, key, opts) ? "" : "?"}: ${val.tsType},
`
      );
    } else if (val.type === "object") {
      buff.push(
        `${(0, _knitwork.genObjectKey)(key)}${isRequired(schema, key, opts) ? "" : "?"}: {`,
      ...
      buff.push(
        `${(0, _knitwork.genObjectKey)(key)}${isRequired(schema, key, opts) ? "" : "?"}: ${type},
`
      );
    }
  }
...
function getTsType(type, opts) {
  if (Array.isArray(type)) {
    return [(0, _untypedBr_uXjZG.n)(type.map((t) => getTsType(t, opts)))].flat().join("|") || "any";
  }
  if (!type) {
    return "any";
  }
