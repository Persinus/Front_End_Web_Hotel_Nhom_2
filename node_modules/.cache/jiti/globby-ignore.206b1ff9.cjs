...
const normalizeOptions = (options = {}) => ({
  cwd: (0, _unicornMagic.toPath)(options.cwd) ?? _nodeProcess.default.cwd(),
...
const isGitIgnoredSync = (options) => isIgnoredByIgnoreFilesSync(GITIGNORE_FILES_PATTERN, options);exports.isGitIgnoredSync = isGitIgnoredSync; /* v9-f370acdb4cc31a23 */
