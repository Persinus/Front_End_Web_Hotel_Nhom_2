"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.S = exports.F = void 0;exports.d = defineHeadPlugin;var _unheadDQc16pHI = require("./unhead.DQc16pHI.mjs");

function defineHeadPlugin(plugin) {
  return plugin;
}

const FlatMetaPlugin = exports.F = /* @__PURE__ */defineHeadPlugin({
  key: "flatMeta",
  hooks: {
    "entries:normalize": (ctx) => {
      ...
      ctx.tags = ctx.tags.map((t) => {
        ...
        tagsToAdd.push((0, _unheadDQc16pHI.u)(t.props).map((p) => ({
          ...t,
          tag: "meta",
          props: p
        })));
...
const SafeInputPlugin = exports.S =
/* @PURE */
defineHeadPlugin({
  key: "safe",
  hooks: {
