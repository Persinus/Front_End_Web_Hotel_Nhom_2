"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = getValue;exports.b = nonEmpty;exports.c = getTypeDescriptor;exports.d = defineUntypedSchema;exports.e = cachedFn;exports.g = getType;exports.i = isObject;exports.j = joinPath;exports.m = mergedTypes;exports.n = normalizeTypes;exports.s = setValue;exports.u = unique;var _scule = require("scule");
  ...
  for (const match of type.matchAll(FRIENDLY_TYPE_RE) || []) {
    ...
    if (importName && firstType) {
      markdownType = markdownType.replace(
        match[0],
        (0, _scule.pascalCase)(importName) + (0, _scule.pascalCase)(firstType)
      );
    }
  }
  return {
