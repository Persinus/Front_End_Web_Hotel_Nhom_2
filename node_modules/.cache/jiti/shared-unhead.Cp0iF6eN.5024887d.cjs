"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = normalizeProps;exports.d = dedupeKey;exports.h = hashTag;exports.i = isMetaArrayDupeKey;exports.n = normalizeEntryToTags;exports.w = walkResolver;var _unheadYem5I2v_ = require("./unhead.yem5I2v_.mjs");

const allowedMetaProperties = ["name", "property", "http-equiv"];
function isMetaArrayDupeKey(v) {
  const k = v.split(":")[1];
  return _unheadYem5I2v_.M.has(k);
}
function dedupeKey(tag) {
  const { props, tag: name } = tag;
  if (_unheadYem5I2v_.U.has(name))
  return name;
...
function normalizeTag(tagName, _input) {
  ...
  if (tag.key && _unheadYem5I2v_.D.has(tag.tag)) {
