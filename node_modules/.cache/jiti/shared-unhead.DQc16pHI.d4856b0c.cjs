"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveMetaKeyValue;exports.b = resolvePackedMetaObjectValue;exports.r = resolveMetaKeyType;exports.u = unpackMeta;var _unheadYem5I2v_ = require("./unhead.yem5I2v_.mjs");
...
function handleObjectEntry(key, value) {
  ...
  if (!_unheadYem5I2v_.M.has(fixedKey)) {
...
function unpackMeta(input) {
  ...
  for (const [key, value] of Object.entries(input)) {
    ...
    if (typeof value === "object" && value) {
      ...
      } else if (_unheadYem5I2v_.M.has(fixKeyCase(key))) {
