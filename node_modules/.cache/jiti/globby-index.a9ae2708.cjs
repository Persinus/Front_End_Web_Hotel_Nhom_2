"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.isDynamicPattern = exports.globbySync = exports.globbyStream = exports.globby = exports.generateGlobTasksSync = exports.generateGlobTasks = exports.convertPathToPattern = void 0;Object.defineProperty(exports, "isGitIgnored", { enumerable: true, get: function () {return _ignore.isGitIgnored;} });Object.defineProperty(exports, "isGitIgnoredSync", { enumerable: true, get: function () {return _ignore.isGitIgnoredSync;} });Object.defineProperty(exports, "isIgnoredByIgnoreFiles", { enumerable: true, get: function () {return _ignore.isIgnoredByIgnoreFiles;} });Object.defineProperty(exports, "isIgnoredByIgnoreFilesSync", { enumerable: true, get: function () {return _ignore.isIgnoredByIgnoreFilesSync;} });var _nodeProcess = _interopRequireDefault(require("node:process"));
var _nodeFs = _interopRequireDefault(require("node:fs"));
var _nodePath = _interopRequireDefault(require("node:path"));
var _mergeStreams = _interopRequireDefault(require("@sindresorhus/merge-streams"));
var _fastGlob = _interopRequireDefault(require("fast-glob"));
var _pathType = require("path-type");
var _unicornMagic = require("unicorn-magic");
var _ignore = require("./ignore.js");




var _utilities = require("./utilities.js");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
const getDirectoryGlob = ({ directoryPath, files, extensions }) => {
  ...
  return files ?
  files.map((file) => _nodePath.default.posix.join(directoryPath, `**/${_nodePath.default.extname(file) ? file : `${file}${extensionGlob}`}`)) :
  [_nodePath.default.posix.join(directoryPath, `**${extensionGlob ? `/*${extensionGlob}` : ''}`)];
};
...
const directoryToGlob = async (directoryPaths, {
  ...
  (await (0, _pathType.isDirectory)(normalizePathForDirectoryGlob(directoryPath, cwd))) ? getDirectoryGlob({ directoryPath, files, extensions }) : directoryPath)
  );
...
const directoryToGlobSync = (directoryPaths, {
  ...
  files,
  extensions
} = {}) => directoryPaths.flatMap((directoryPath) => (0, _pathType.isDirectorySync)(normalizePathForDirectoryGlob(directoryPath, cwd)) ? getDirectoryGlob({ directoryPath, files, extensions }) : directoryPath);
...
const { convertPathToPattern } = _fastGlob.default;exports.convertPathToPattern = convertPathToPattern; /* v9-b16e3ca6660cb95e */
