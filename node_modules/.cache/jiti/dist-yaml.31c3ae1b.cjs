...
` : "";}var hr = tr,dr = { dump: hr },sr = ki.load,xr = dr.dump;function mr(e, n) {const i = sr(e, n);return (0, _confboxDA7CpUDY.s)(e, i, n), i;}function gr(e, n) {const i = (0, _confboxDA7CpUDY.g)(e, {}),l = typeof i.indent == "string" ? i.indent.length : i.indent,r = xr(e, { indent: l, ...n });return i.whitespace.start + r.trim() + i.whitespace.end;} /* v9-54b7606a2449379f */
