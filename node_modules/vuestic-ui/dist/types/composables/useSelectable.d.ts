...
import { StatefulProps } from 'vuestic-ui/dist/types/composables/useStateful.js';
import { LoadingProps } from 'vuestic-ui/dist/types/composables/useLoading.js';
import { ValidationProps } from 'vuestic-ui/dist/types/composables/useValidation.js';
...
export declare const useSelectableProps: {
    ...
    rules: {
        type: PropType<import("vuestic-ui/dist/types/composables/useValidation.js").ValidationRule<any>[]>;
        default: () => any;
    };
    dirty: {
        type: BooleanConstructor;
