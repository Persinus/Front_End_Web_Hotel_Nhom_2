import type { ExtractPropType } from 'element-plus/es/utils/index.mjs';
import type { ExtractPropTypes, Ref } from 'vue';
declare const _prop: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => boolean) | (() => boolean | null) | ((new (...args: any[]) => boolean) | (() => boolean | null))[], never, never, null, false>;
