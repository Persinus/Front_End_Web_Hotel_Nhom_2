import type TreeStore from 'element-plus/es/components/tree/src/model/tree-store.mjs';
import type { Nullable } from 'element-plus/es/utils/index.mjs';
import type { FakeNode, TreeKey, TreeNodeChildState, TreeNodeData, TreeNodeLoadedDefaultProps, TreeNodeOptions } from 'element-plus/es/components/tree/src/tree.type.mjs';
