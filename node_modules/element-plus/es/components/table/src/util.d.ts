import { type ElTooltipProps } from 'element-plus/es/components/tooltip/index.mjs';
import type { Table, TreeProps } from 'element-plus/es/components/table/src/table/defaults.mjs';
