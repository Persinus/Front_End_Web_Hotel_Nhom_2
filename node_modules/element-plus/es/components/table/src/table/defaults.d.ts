...
import type TableLayout from 'element-plus/es/components/table/src/table-layout.mjs';
import type { TableOverflowTooltipFormatter, TableOverflowTooltipOptions } from 'element-plus/es/components/table/src/util.mjs';
