...
import type { Table } from 'element-plus/es/components/table/src/table/defaults.mjs';
declare const _default: import("vue").DefineComponent<{
    ...
    store: any;
    columns: import("vue").ComputedRef<import("element-plus/es/components/table/src/table-column/defaults.mjs").TableColumnCtx<unknown>>;
