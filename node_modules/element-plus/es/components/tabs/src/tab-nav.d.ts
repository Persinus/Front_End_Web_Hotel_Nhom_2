...
import type { TabPaneName } from 'element-plus/es/components/tabs/src/tabs.mjs';
export declare const tabNavProps: {
    readonly panes: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => {
        uid: number;
    ...
    readonly currentName: import("element-plus/es/utils/index.mjs").EpPropFinalized<readonly [StringConstructor, NumberConstructor], unknown, unknown, "", boolean>;
...
declare const TabNav: import("vue").DefineComponent<{
    ...
    readonly currentName: import("element-plus/es/utils/index.mjs").EpPropMergeType<readonly [StringConstructor, NumberConstructor], unknown, unknown>;
}>;
