...
import type { ConfigProviderContext } from 'element-plus/es/components/config-provider/src/constants.mjs';
...
export declare function useGlobalComponentSettings(block: string, sizeFallback?: MaybeRef<ConfigProviderContext['size']>): {
    ...
    locale: import("element-plus/es/hooks/index.mjs").LocaleContext;
    zIndex: {
