import type { MessageConfigContext } from 'element-plus/es/components/message/index.mjs';
...
declare const ConfigProvider: import("vue").DefineComponent<{
    ...
    readonly button: {
        readonly type: import("vue").PropType<import("element-plus/es/components/button/index.mjs").ButtonConfigContext>;
        readonly required: false;
        readonly validator: ((val: unknown) => boolean) | undefined;
        __epPropKey: true;
    };
    readonly experimentalFeatures: {
        readonly type: import("vue").PropType<import("element-plus/es/components/config-provider/src/config-provider-props.mjs").ExperimentalFeatures>;
        readonly required: false;
        readonly validator: ((val: unknown) => boolean) | undefined;
        __epPropKey: true;
    };
