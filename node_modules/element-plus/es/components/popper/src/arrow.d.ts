...
import type Arrow from 'element-plus/es/components/popper/src/arrow.vue.mjs';
export declare const popperArrowProps: {
    readonly arrowOffset: import("element-plus/es/utils/index.mjs").EpPropFinalized<NumberConstructor, unknown, unknown, 5, boolean>;
};
