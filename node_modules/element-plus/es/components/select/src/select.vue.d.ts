declare const _default: import("vue").DefineComponent<{
    ...
    modelValue: import("element-plus/es/utils/index.mjs").EpPropFinalized<(ArrayConstructor | ObjectConstructor | NumberConstructor | StringConstructor | BooleanConstructor)[], unknown, unknown, undefined, boolean>;
    ...
    effect: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => string) | (() => import("element-plus/es/components/popper/index.mjs").PopperEffect) | ((new (...args: any[]) => string) | (() => import("element-plus/es/components/popper/index.mjs").PopperEffect))[], unknown, unknown, string, boolean>;
    ...
    tagType: {
        default: string;
        type: import("vue").PropType<import("element-plus/es/utils/index.mjs").EpPropMergeType<StringConstructor, "success" | "warning" | "info" | "primary" | "danger", unknown>>;
        required: false;
    ...
    placement: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => "top" | "bottom" | "left" | "right" | "auto" | "auto-start" | "auto-end" | "top-start" | "top-end" | "bottom-start" | "bottom-end" | "right-start" | "right-end" | "left-start" | "left-end") | (() => import("element-plus").Placement) | ((new (...args: any[]) => "top" | "bottom" | "left" | "right" | "auto" | "auto-start" | "auto-end" | "top-start" | "top-end" | "bottom-start" | "bottom-end" | "right-start" | "right-end" | "left-start" | "left-end") | (() => import("element-plus").Placement))[], import("element-plus").Placement, unknown, string, boolean>;
    ...
    onOptionCreate: (vm: import("element-plus/es/components/select/src/token.mjs").SelectOptionProxy) => void;
    onOptionDestroy: (key: any, vm: import("element-plus/es/components/select/src/token.mjs").SelectOptionProxy) => void;
    ...
    tooltipRef: import("vue").Ref<import("element-plus/es/components/tooltip/index.mjs").TooltipInstance | null>;
    tagTooltipRef: import("vue").Ref<import("element-plus/es/components/tooltip/index.mjs").TooltipInstance | null>;
    ...
    multiple: boolean;
    loading: boolean;
    modelValue: import("element-plus/es/utils/index.mjs").EpPropMergeType<(ArrayConstructor | ObjectConstructor | NumberConstructor | StringConstructor | BooleanConstructor)[], unknown, unknown>;
    ...
    tagType: import("element-plus/es/utils/index.mjs").EpPropMergeType<StringConstructor, "success" | "warning" | "info" | "primary" | "danger", unknown>;
