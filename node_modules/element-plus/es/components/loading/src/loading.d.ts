import type { LoadingOptionsResolved } from 'element-plus/es/components/loading/src/types.mjs';
export declare function createLoadingComponent(options: LoadingOptionsResolved): {
    ...
    parent: import("vue").Ref<import("element-plus/es/components/loading/src/types.mjs").LoadingParentElement>;
