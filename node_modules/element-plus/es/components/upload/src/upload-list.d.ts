...
import type { UploadFile, UploadFiles } from 'element-plus/es/components/upload/src/upload.mjs';
import type UploadList from 'element-plus/es/components/upload/src/upload-list.vue.mjs';
export declare const uploadListProps: {
    readonly files: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => UploadFiles) | (() => UploadFiles) | ((new (...args: any[]) => UploadFiles) | (() => UploadFiles))[], unknown, unknown, () => never[], boolean>;
    ...
    readonly handlePreview: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => (uploadFile: UploadFile) => void) | (() => (uploadFile: UploadFile) => void) | {
