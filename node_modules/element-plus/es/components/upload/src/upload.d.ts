import type { Awaitable, Mutable } from 'element-plus/es/utils/index.mjs';
import type { UploadAjaxError } from 'element-plus/es/components/upload/src/ajax.mjs';
import type { ExtractPropTypes } from 'vue';
import type Upload from 'element-plus/es/components/upload/src/upload.vue.mjs';
...
export declare const uploadBaseProps: {
    ...
    readonly fileList: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => UploadUserFile[]) | (() => UploadUserFile[]) | ((new (...args: any[]) => UploadUserFile[]) | (() => UploadUserFile[]))[], unknown, unknown, () => [], boolean>;
    ...
    readonly httpRequest: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => UploadRequestHandler) | (() => UploadRequestHandler) | {
...
export declare const uploadProps: {
    readonly beforeUpload: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => (rawFile: UploadRawFile) => Awaitable<void | undefined | null | boolean | File | Blob>) | (() => (rawFile: UploadRawFile) => Awaitable<void | undefined | null | boolean | File | Blob>) | {
    ...
    readonly onProgress: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => (evt: UploadProgressEvent, uploadFile: UploadFile, uploadFiles: UploadFiles) => void) | (() => (evt: UploadProgressEvent, uploadFile: UploadFile, uploadFiles: UploadFiles) => void) | {
    ...
    readonly onExceed: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => (files: File[], uploadFiles: UploadUserFile[]) => void) | (() => (files: File[], uploadFiles: UploadUserFile[]) => void) | {
