...
import type { SliderMarkerProps } from 'element-plus/es/components/slider/src/marker.mjs';
import type Slider from 'element-plus/es/components/slider/src/slider.vue.mjs';
...
export declare const sliderProps: {
    ...
    readonly modelValue: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => number | number[]) | (() => Arrayable<number>) | ((new (...args: any[]) => number | number[]) | (() => Arrayable<number>))[], unknown, unknown, 0, boolean>;
    ...
    readonly placement: import("element-plus/es/utils/index.mjs").EpPropFinalized<StringConstructor, import("@popperjs/core").Placement, unknown, "top", boolean>;
    readonly marks: {
