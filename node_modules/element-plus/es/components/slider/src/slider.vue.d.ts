declare const _default: import("vue").DefineComponent<{
    ...
    readonly modelValue: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => number | number[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<number>) | ((new (...args: any[]) => number | number[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<number>))[], unknown, unknown, 0, boolean>;
    ...
    "update:modelValue": (value: import("element-plus/es/utils/index.mjs").Arrayable<number>) => void;
    change: (value: import("element-plus/es/utils/index.mjs").Arrayable<number>) => void;
    input: (value: import("element-plus/es/utils/index.mjs").Arrayable<number>) => void;
    ...
    "onUpdate:modelValue"?: ((value: import("element-plus/es/utils/index.mjs").Arrayable<number>) => any) | undefined;
    onChange?: ((value: import("element-plus/es/utils/index.mjs").Arrayable<number>) => any) | undefined;
    onInput?: ((value: import("element-plus/es/utils/index.mjs").Arrayable<number>) => any) | undefined;
}, {
    readonly disabled: boolean;
    readonly vertical: boolean;
    readonly range: boolean;
    readonly id: string;
    readonly modelValue: import("element-plus/es/utils/index.mjs").EpPropMergeType<(new (...args: any[]) => number | number[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<number>) | ((new (...args: any[]) => number | number[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<number>))[], unknown, unknown>;
