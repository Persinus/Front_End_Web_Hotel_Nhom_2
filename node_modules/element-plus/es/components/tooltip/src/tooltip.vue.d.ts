import type { TooltipContentInstance } from 'element-plus/es/components/tooltip/src/content.mjs';
import type { PopperInstance } from 'element-plus/es/components/popper/index.mjs';
...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    trigger: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => "click" | "contextmenu" | "focus" | "hover" | import("element-plus").TooltipTriggerType[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<import("element-plus").TooltipTriggerType>) | ((new (...args: any[]) => "click" | "contextmenu" | "focus" | "hover" | import("element-plus").TooltipTriggerType[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<import("element-plus").TooltipTriggerType>))[], unknown, unknown, "hover", boolean>;
    ...
    virtualRef: {
        readonly type: import("vue").PropType<import("element-plus/es/components/popper/index.mjs").Measurable>;
    ...
    effect: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => string) | (() => import("element-plus/es/components/popper/index.mjs").PopperEffect) | ((new (...args: any[]) => string) | (() => import("element-plus/es/components/popper/index.mjs").PopperEffect))[], unknown, unknown, "dark", boolean>;
    ...
    fallbackPlacements: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => import("element-plus/es/components/popper/index.mjs").Placement[]) | (() => import("element-plus/es/components/popper/index.mjs").Placement[]) | ((new (...args: any[]) => import("element-plus/es/components/popper/index.mjs").Placement[]) | (() => import("element-plus/es/components/popper/index.mjs").Placement[]))[], unknown, unknown, undefined, boolean>;
    ...
    placement: import("element-plus/es/utils/index.mjs").EpPropFinalized<StringConstructor, import("element-plus/es/components/popper/index.mjs").Placement, unknown, "bottom", boolean>;
    ...
    open: boolean;
    placement: import("element-plus/es/utils/index.mjs").EpPropMergeType<StringConstructor, import("element-plus/es/components/popper/index.mjs").Placement, unknown>;
    strategy: import("element-plus/es/utils/index.mjs").EpPropMergeType<StringConstructor, "fixed" | "absolute", unknown>;
    effect: import("element-plus/es/utils/index.mjs").EpPropMergeType<(new (...args: any[]) => string) | (() => import("element-plus/es/components/popper/index.mjs").PopperEffect) | ((new (...args: any[]) => string) | (() => import("element-plus/es/components/popper/index.mjs").PopperEffect))[], unknown, unknown>;
    showAfter: number;
    hideAfter: number;
    autoClose: number;
    ...
    trigger: import("element-plus/es/utils/index.mjs").EpPropMergeType<(new (...args: any[]) => "click" | "contextmenu" | "focus" | "hover" | import("element-plus").TooltipTriggerType[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<import("element-plus").TooltipTriggerType>) | ((new (...args: any[]) => "click" | "contextmenu" | "focus" | "hover" | import("element-plus").TooltipTriggerType[]) | (() => import("element-plus/es/utils/index.mjs").Arrayable<import("element-plus").TooltipTriggerType>))[], unknown, unknown>;
    arrowOffset: number;
    virtualTriggering: boolean;
    boundariesPadding: number;
    fallbackPlacements: import("element-plus/es/components/popper/index.mjs").Placement[];
    gpuAcceleration: import("element-plus/es/utils/index.mjs").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    popperOptions: Partial<import("element-plus/es/components/popper/index.mjs").Options>;
    enterable: import("element-plus/es/utils/index.mjs").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    focusOnShow: import("element-plus/es/utils/index.mjs").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    trapping: import("element-plus/es/utils/index.mjs").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    stopPopperMouseEvent: import("element-plus/es/utils/index.mjs").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    pure: boolean;
    triggerKeys: string[];
