import type { GridInstance } from 'element-plus/es/components/virtual-list/src/builders/build-grid.mjs';
import type { ItemSize } from 'element-plus/es/components/virtual-list/src/types.mjs';
type Indices = {
    columnIndex?: number;
    rowIndex?: number;
};
declare const DynamicSizeGrid: import("vue").DefineComponent<{
    ...
    readonly itemKey: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => import("element-plus/es/components/virtual-list/src/types.mjs").GridItemKeyGetter) | (() => import("element-plus/es/components/virtual-list/src/types.mjs").GridItemKeyGetter) | {
        (): import("element-plus/es/components/virtual-list/src/types.mjs").GridItemKeyGetter;
        new (): any;
        readonly prototype: any;
    } | ((new (...args: any[]) => import("element-plus/es/components/virtual-list/src/types.mjs").GridItemKeyGetter) | (() => import("element-plus/es/components/virtual-list/src/types.mjs").GridItemKeyGetter) | {
        (): import("element-plus/es/components/virtual-list/src/types.mjs").GridItemKeyGetter;
        new (): any;
        readonly prototype: any;
    ...
    readonly itemKey: import("element-plus/es/components/virtual-list/src/types.mjs").GridItemKeyGetter;
