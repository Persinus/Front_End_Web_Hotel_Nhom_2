...
import type { GridDefaultSlotParams, GridScrollOptions, ResetAfterIndex, Alignment as ScrollStrategy } from 'element-plus/es/components/virtual-list/index.mjs';
import type { TableV2GridProps } from 'element-plus/es/components/table-v2/src/grid.mjs';
declare const TableGrid: import("vue").DefineComponent<{
    ...
    readonly getRowHeight: {
        readonly type: import("vue").PropType<import("element-plus/es/components/virtual-list/index.mjs").ItemSize>;
        readonly required: true;
        readonly validator: ((val: unknown) => boolean) | undefined;
        __epPropKey: true;
    };
    readonly rowKey: import("element-plus/es/utils/index.mjs").EpPropFinalized<(new (...args: any[]) => string | number | symbol) | (() => import("element-plus/es/components/table-v2/src/types.mjs").KeyType) | ((new (...args: any[]) => string | number | symbol) | (() => import("element-plus/es/components/table-v2/src/types.mjs").KeyType))[], unknown, unknown, "id", boolean>;
