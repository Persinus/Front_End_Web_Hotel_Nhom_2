...
import { ref, computed, resolveComponent, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="page-container" data-v-cff0fea4>`);
      if (loading.value) {
        _push(`<div class="modal-loading" data-v-cff0fea4><div class="modal-loading-backdrop" data-v-cff0fea4></div><div class="modal-loading-content" data-v-cff0fea4><span class="loader" data-v-cff0fea4></span><span data-v-cff0fea4>\u0110ang t\u1EA3i d\u1EEF li\u1EC7u...</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (error.value) {
        _push(`<div class="error-message" data-v-cff0fea4>${ssrInterpolate(error.value)}</div>`);
      } else {
        _push(`<div data-v-cff0fea4>`);
        _push(ssrRenderComponent(CardRooms, {
          rooms: pagedRooms.value,
...
const phong = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cff0fea4"]]);

export { phong as default };
//# sourceMappingURL=phong-BWKhu0E7.mjs.map
