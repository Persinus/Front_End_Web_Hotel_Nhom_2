...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-4693b538><div class="container" data-v-4693b538>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="logo-icon" data-v-4693b538${_scopeId}><svg viewBox="0 0 24 24" class="logo-svg" data-v-4693b538${_scopeId}><path d="M12 2L2 7v10c0 5.55 3.84 10 9 11 1.16.21 2.76.21 3.91 0 5.16-1 9-5.45 9-11V7l-10-5z" data-v-4693b538${_scopeId}></path><path d="M12 7v5l4 2-4 2v5" data-v-4693b538${_scopeId}></path></svg></div><div class="logo-text" data-v-4693b538${_scopeId}><span class="brand-name" data-v-4693b538${_scopeId}>OceanView</span><span class="brand-tagline" data-v-4693b538${_scopeId}>Luxury Hotels</span></div>`);
          } else {
            return [
      ...
      _push(`<nav class="${ssrRenderClass(["nav", { "nav-open": isMenuOpen.value }])}" data-v-4693b538><ul class="nav-list" data-v-4693b538><!--[-->`);
      ssrRenderList(navItems, (item) => {
        _push(`<li class="nav-item" data-v-4693b538>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          class: "nav-link",
          to: item.link,
          "active-class": "active",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span data-v-4693b538${_scopeId}>${ssrInterpolate(item.title)}</span>`);
            } else {
              return [
      ...
      _push(`<!--]--></ul></nav><div class="header-actions" data-v-4693b538><button class="theme-toggle"${ssrRenderAttr("title", isDarkMode.value ? "Chuy\u1EC3n sang Light Mode" : "Chuy\u1EC3n sang Dark Mode")} data-v-4693b538>`);
      _push(ssrRenderComponent(_component_va_icon, {
        name: isDarkMode.value ? "light_mode" : "dark_mode"
      }, null, _parent));
      _push(`</button><div class="auth-section" data-v-4693b538>`);
      if (isLoggedIn.value) {
        _push(ssrRenderComponent(DropDown, {
          ...
          anchor: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              _push2(`<div class="user-avatar" data-v-4693b538${_scopeId}><div class="avatar-container" data-v-4693b538${_scopeId}><img${ssrRenderAttr(
                "src",
              ...
              )} alt="Avatar" class="avatar" data-v-4693b538${_scopeId}><div class="status-indicator online" data-v-4693b538${_scopeId}></div></div><div class="user-info" data-v-4693b538${_scopeId}><span class="username" data-v-4693b538${_scopeId}>${ssrInterpolate(((_b = userProfile.value) == null ? void 0 : _b.HoTen) || ((_c = userProfile.value) == null ? void 0 : _c.TenTaiKhoan) || "Ng\u01B0\u1EDDi d\xF9ng")}</span><span class="user-role" data-v-4693b538${_scopeId}>${ssrInterpolate((_d = userProfile.value) == null ? void 0 : _d.Vaitro)}</span></div>`);
              _push2(ssrRenderComponent(_component_va_icon, {
                name: "expand_more",
                size: "small",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              _push2(`<div class="dropdown-content" data-v-4693b538${_scopeId}><div class="user-profile-section" data-v-4693b538${_scopeId}><div class="profile-header" data-v-4693b538${_scopeId}><img${ssrRenderAttr(
                "src",
                ((_a = userProfile.value) == null ? void 0 : _a.HinhAnhURL) || "https://i.pinimg.com/736x/cd/62/46/cd624642b71af4a1d73f69b1290c751a.jpg"
              )} class="profile-avatar" data-v-4693b538${_scopeId}><div data-v-4693b538${_scopeId}><h4 data-v-4693b538${_scopeId}>${ssrInterpolate(((_b = userProfile.value) == null ? void 0 : _b.HoTen) || "Ng\u01B0\u1EDDi d\xF9ng")}</h4><p data-v-4693b538${_scopeId}>${ssrInterpolate((_c = userProfile.value) == null ? void 0 : _c.Email)}</p></div></div></div><div class="dropdown-divider" data-v-4693b538${_scopeId}></div><div class="dropdown-menu-items" data-v-4693b538${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-4693b538${_scopeId2}>H\u1ED3 s\u01A1 c\xE1 nh\xE2n</span>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-4693b538${_scopeId2}>\u0110\u1EB7t ph\xF2ng c\u1EE7a t\xF4i</span>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-4693b538${_scopeId2}>Y\xEAu th\xEDch</span>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span data-v-4693b538${_scopeId2}>C\xE0i \u0111\u1EB7t</span>`);
                  } else {
                    return [
              ...
              _push2(`</div><div class="dropdown-divider" data-v-4693b538${_scopeId}></div><div class="dropdown-item logout-item" data-v-4693b538${_scopeId}>`);
              _push2(ssrRenderComponent(_component_va_icon, { name: "logout" }, null, _parent2, _scopeId));
              _push2(`<span data-v-4693b538${_scopeId}>\u0110\u0103ng xu\u1EA5t</span></div></div>`);
            } else {
              return [
        ...
        _push(`<div class="auth-buttons" data-v-4693b538>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/DangNhap",
      ...
      _push(`</div></div></div><div class="scroll-progress" style="${ssrRenderStyle({ width: scrollProgress.value + "%" })}" data-v-4693b538></div></header>`);
    };
  }
};
...
const TheHeader = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4693b538"]]);

export { TheHeader as T };
//# sourceMappingURL=Header-gOHbRZPv.mjs.map
