import { ref, computed, defineComponent, resolveComponent, mergeProps, createVNode, resolveDynamicComponent, unref, withCtx, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, reactive, Fragment, renderList, useSSRContext } from 'vue';
...
import { useForm, VaForm, VaInput, VaDateInput, VaTimeInput, VaCounter, VaSelect, VaSlider, VaSwitch, VaOptionList, VaCheckbox, VaButton, VaFileUpload, useColors } from 'vuestic-ui';
...
const Alert = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["ssrRender", _sfc_ssrRender$e]]);
const _sfc_main$l = {};
...
const Button = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$d]]);
const _sfc_main$k = {
  data() {
    return {
      value: 0,
...
const Carousel = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["ssrRender", _sfc_ssrRender$c]]);
...
const DataTable = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$b]]);
const _sfc_main$i = {};
...
const Icon = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["ssrRender", _sfc_ssrRender$a]]);
const _sfc_main$h = {
  __name: "Modal",
...
const TableClickable = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$9]]);
const _sfc_main$f = {
  data() {
    return {
      value: true,
...
const Label = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$e = {
  data() {
    return {
...
const Date_Input = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$d = {
...
const FileUpload = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(VaForm), {
        ref_key: "formRef",
        ref: formRef,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(VaDateInput), {
              modelValue: form.birthDate,
              "onUpdate:modelValue": ($event) => form.birthDate = $event,
              rules: [(v) => validateBirthday(v)],
              label: "Birth Date",
              "manual-input": "",
              clearable: ""
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(unref(VaTimeInput), {
              modelValue: form.time,
              "onUpdate:modelValue": ($event) => form.time = $event,
              rules: [(v) => v || "We need to now pick-up time!"],
              label: "Pick-up time",
              "manual-input": "",
              clearable: ""
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(unref(VaCounter), {
              modelValue: form.count,
              "onUpdate:modelValue": ($event) => form.count = $event,
              label: "Amount",
            ...
            _push2(ssrRenderComponent(unref(VaSelect), {
              ...
              "onUpdate:modelValue": ($event) => form.country = $event,
              options: countries,
              rules: [(v) => v || "Field is required", (v) => v === "ua" ? "Delivery currently unavailable in your country" : void 0],
              label: "Country"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(unref(VaSlider), {
              ...
              rules: [
                ...
                (v) => form.country === "us" && v > 20 ? "Package to US can not be more than 20kg" : true
              ],
              label: "Weight, kg",
              style: { "width": "100%" }
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(unref(VaSwitch), {
              modelValue: form.notifications,
              "onUpdate:modelValue": ($event) => form.notifications = $event,
              label: "Notifications",
              size: "small",
              rules: [(v) => v || "You must agree on notifications"]
            }, null, _parent2, _scopeId));
            _push2(`<div${_scopeId}><span class="va-title"${_scopeId}>Payment method</span>`);
            _push2(ssrRenderComponent(unref(VaOptionList), {
              modelValue: form.paymentMethod,
              "onUpdate:modelValue": ($event) => form.paymentMethod = $event,
              options: ["Visa", "MasterCard", "PayPal"],
              rules: [(v) => v === "PayPal" || "Only PayPal is currently available"],
              type: "radio"
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
            _push2(ssrRenderComponent(unref(VaCheckbox), {
              modelValue: form.acknowledgement,
              "onUpdate:modelValue": ($event) => form.acknowledgement = $event,
            ...
            _push2(ssrRenderComponent(unref(VaButton), {
              ...
              onClick: ($event) => unref(validate)() && submit()
            }, {
            ...
            return [
              ...
              createVNode("div", null, [
                createVNode("span", { class: "va-title" }, "Payment method"),
                createVNode(unref(VaOptionList), {
                  modelValue: form.paymentMethod,
                  "onUpdate:modelValue": ($event) => form.paymentMethod = $event,
                  options: ["Visa", "MasterCard", "PayPal"],
                  rules: [(v) => v === "PayPal" || "Only PayPal is currently available"],
      ...
      _push(`<div class="mt-8 flex w-full gap-3 background-element">`);
      _push(ssrRenderComponent(unref(VaButton), {
        onClick: ($event) => unref(validate)() && submit()
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(ssrRenderComponent(unref(VaButton), { onClick: unref(resetValidation) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Reset validation `);
          } else {
            return [
      ...
      _push(ssrRenderComponent(unref(VaButton), { onClick: unref(reset) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Reset `);
          } else {
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("Component_Vuestic/Form.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ui-demo-layout" }, _attrs))} data-v-80263071><div class="ui-list" data-v-80263071>`);
      ...
      _push(`</div><div class="ui-preview" data-v-80263071>`);
...
const TestcomponentVuestic = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-80263071"]]);

export { TestcomponentVuestic as default };
//# sourceMappingURL=TestcomponentVuestic-DtfjUJ9Y.mjs.map
